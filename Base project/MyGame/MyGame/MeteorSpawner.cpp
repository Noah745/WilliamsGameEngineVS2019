...
//The number of milliseconds etween meteor spawns.
...
void MeteorSpawner::update(sf::Time& elapsed)
{
	...
	if (timer_ <= 0)
	{
		...
		//Spawn the meteor off to the right side of the screen.
		//Assuming the meteor isn't more than 100 pixels wide.
